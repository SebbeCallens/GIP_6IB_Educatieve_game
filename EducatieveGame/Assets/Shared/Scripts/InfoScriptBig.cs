...
public class InfoScriptBig : MonoBehaviour
{
    ...
    private void TweenTabs(int enterIndex, int exitIndex, char direction) // F = forwards, B = backwards
    {
        if (direction == 'F')
        {
            ...
            _infoTabs[enterIndex].transform.localPosition = new Vector3(20, _infoTabs[enterIndex].transform.localPosition.y, _infoTabs[enterIndex].transform.localPosition.z);
            ...
            LeanTween.moveLocalX(_infoTabs[exitIndex], -20f, 1);
        }
        else
        {
