...
public class EndScreenLogic : MonoBehaviour
{
    ...
    private static int Difficulty { get => _difficulty; set => _difficulty = value; }
    ...
    public static void EndGame(string sceneName, string gameName, string score, int difficulty, float cameraSize, float offsetY)
    {
